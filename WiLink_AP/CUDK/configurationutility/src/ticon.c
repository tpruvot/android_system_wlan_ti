...
#define SUPPL_IF_FILE "/data/misc/wifi/tiap0"
...
static S32 TiCon_Init_Console_Menu(TiCon_t* pTiCon)
{
    ...
    /* AP Role new Menu */
    CHK_NULL(h1 = (THandle) Console_AddDirExt(pTiCon->hConsole,  (THandle) h, (PS8)"ap rolE", (PS8)"Ap Role menu" ) );
	{
        {
            ConParm_t aaa[]  = { {(PS8)"param 0", 	CON_PARM_RANGE | CON_PARM_OPTIONAL, 1, HOSTAPD_PARAM_LAST, 1},
                                 {(PS8)"param 1", 	CON_PARM_STRING | CON_PARM_OPTIONAL, 0, 64, 0 },
                                 {(PS8)"param 2", 	CON_PARM_STRING | CON_PARM_OPTIONAL, 0, 64, 0 },
                                 {(PS8)"param 3", 	CON_PARM_STRING | CON_PARM_OPTIONAL, 0, 64, 0 },
                                 {(PS8)"param 4", 	CON_PARM_STRING | CON_PARM_OPTIONAL, 0, 32, 0 },
                                 {(PS8)"param 5", 	CON_PARM_STRING | CON_PARM_OPTIONAL, 0, 32, 0 },
                                 {(PS8)"param 6", 	CON_PARM_STRING | CON_PARM_OPTIONAL, 0, 32, 0 },
                                 {(PS8)"param 7", 	CON_PARM_STRING | CON_PARM_OPTIONAL, 0, 32, 0 },
                                 {(PS8)"param 8", 	CON_PARM_STRING | CON_PARM_OPTIONAL, 0, 32, 0 },
                                 {(PS8)"param 9", 	CON_PARM_STRING | CON_PARM_OPTIONAL, 0, 32, 0 },
                                 {(PS8)"param 10", 	CON_PARM_STRING | CON_PARM_OPTIONAL, 0, 32, 0 },
                                 {(PS8)"param 11", 	CON_PARM_STRING | CON_PARM_OPTIONAL, 0, 32, 0 },
                                 {(PS8)"param 12", 	CON_PARM_STRING | CON_PARM_OPTIONAL, 0, 32, 0 },
                                 {(PS8)"param 13", 	CON_PARM_STRING | CON_PARM_OPTIONAL, 0, 32, 0 },
                                 {(PS8)"param 14", 	CON_PARM_STRING | CON_PARM_OPTIONAL, 0, 32, 0 },
                                 {(PS8)"param 15", 	CON_PARM_STRING | CON_PARM_OPTIONAL, 0, 32, 0 },
                                 {(PS8)"param 16", 	CON_PARM_STRING | CON_PARM_OPTIONAL, 0, 32, 0 },
                                 CON_LAST_PARM };
            Console_AddToken(pTiCon->hConsole, h1, (PS8)"Configure",  (PS8)"configure", (FuncToken_t) CuCmd_ApRoleUpdateKeyInConfFile, aaa );
             
        }
        {
              ConParm_t aaa[]  = { { (PS8)"Save", CON_PARM_RANGE | CON_PARM_OPTIONAL, 0, 1, 1 }, CON_LAST_PARM };
              Console_AddToken(pTiCon->hConsole, h1, (PS8)"Save configuration",  (PS8)"Save configuration", (FuncToken_t) CuCmd_ApRoleSaveChanges, aaa );
        } 
			  Console_AddToken(pTiCon->hConsole, h1, (PS8)"Restart",  (PS8)"Restart the AP", (FuncToken_t) CuCmd_SendResetCmdToHostapd, NULL );
              Console_AddToken(pTiCon->hConsole, h1, (PS8)"bss stOp",  (PS8)"BSS stop", (FuncToken_t) CuCmd_SendStopCmdToHostapd, NULL );
	    {
			  ConParm_t aaa[]  = { { (PS8)"ConfigFname", CON_PARM_STRING, 0, 80, 0 }, CON_LAST_PARM };
              Console_AddToken(pTiCon->hConsole, h1, (PS8)"bss stArt",  (PS8)"BSS start", (FuncToken_t) CuCmd_SendStartCmdToHostapd, aaa );
		}
        {
              ConParm_t aaa[]  = { { (PS8)"Show", CON_PARM_RANGE | CON_PARM_OPTIONAL, 0, 1, 1 }, CON_LAST_PARM };
    ...
    CHK_NULL(h = (THandle) Console_AddDirExt(pTiCon->hConsole,  (THandle) NULL, (PS8)"dEbug", (PS8)"Debug features" ) );	
	{
      ...
      /* AP-ROLE debug menu is starting from here!!  */
      CHK_NULL(h1 = (THandle) Console_AddDirExt(pTiCon->hConsole,  (THandle)h , (PS8)"Ap role debug", (PS8)"debug ap role" )); 
      {
          {
              ConParm_t aaa[]  = { { (PS8)"bssIndex", CON_PARM_RANGE | CON_PARM_OPTIONAL , 0, 10, 1 }, CON_LAST_PARM };
              Console_AddToken(pTiCon->hConsole, h1, (PS8)"sTart Bss",  (PS8)"start bss", (FuncToken_t) CuCmd_ApRoleDbgBssStart, aaa );
          }
          {
              ConParm_t aaa[]  = { { (PS8)"bssIndex", CON_PARM_RANGE | CON_PARM_OPTIONAL, 0, 10, 1 }, CON_LAST_PARM };
              Console_AddToken(pTiCon->hConsole, h1, (PS8)"stoP Bss",  (PS8)"stop bss", (FuncToken_t) CuCmd_ApRoleDbgBssStop, aaa );
          }
          {
              ConParm_t aaa[]  = { { (PS8)"channel", CON_PARM_RANGE | CON_PARM_OPTIONAL, 1, 14, 1 }, CON_LAST_PARM };
              Console_AddToken(pTiCon->hConsole, h1, (PS8)"Channel",  (PS8)"channel", (FuncToken_t) CuCmd_ApRoleSetChannel, aaa );
          }
          {
              ConParm_t aaa[]  = { { (PS8)"ssid type", CON_PARM_RANGE | CON_PARM_OPTIONAL, 0, 1, 1 }, CON_LAST_PARM };
              Console_AddToken(pTiCon->hConsole, h1, (PS8)"Ssid type",  (PS8)"ssid type", (FuncToken_t) CuCmd_ApRoleSetSSIDType, aaa );
          }
          {
              ConParm_t aaa[]  = { { (PS8)"beacon interval", CON_PARM_RANGE | CON_PARM_OPTIONAL, 0, 9999, 100 }, CON_LAST_PARM };
              Console_AddToken(pTiCon->hConsole, h1, (PS8)"Beacon interval",  (PS8)"beacon interval", (FuncToken_t) CuCmd_ApRoleSetBeconInterval, aaa );
          }
          {
              ConParm_t aaa[]  = { { (PS8)"dtim interval", CON_PARM_RANGE | CON_PARM_OPTIONAL, 0, 9999, 2 }, CON_LAST_PARM };
              Console_AddToken(pTiCon->hConsole, h1, (PS8)"Dtim interval",  (PS8)"dtim interval", (FuncToken_t) CuCmd_ApRoleSetDTIMInterval, aaa );
          }
          {
              ConParm_t aaa[]  = { {(PS8)"ssid", 	CON_PARM_STRING | CON_PARM_OPTIONAL, 0, 32, 0 }, CON_LAST_PARM };
              Console_AddToken(pTiCon->hConsole, h1, (PS8)"ssId",  (PS8)"ssid", (FuncToken_t) CuCmd_ApRoleSetSSID, aaa );
          }
          {
              ConParm_t aaa[]  = { {(PS8)"Command ID", 	CON_PARM_RANGE  | CON_PARM_OPTIONAL, 0, 9999, 0 }, 
                                   {(PS8)"Command Buffer", 	CON_PARM_STRING | CON_PARM_OPTIONAL, 0, 250, 0 }, CON_LAST_PARM };
              Console_AddToken(pTiCon->hConsole, h1, (PS8)"Generic command",  (PS8)"generic Command", (FuncToken_t) CuCmd_SetGenericCmdToFW, aaa );
          }
          {
              Console_AddToken(pTiCon->hConsole, h1, (PS8)"pRint DB",  (PS8)"print AP Role DB", (FuncToken_t) CuCmd_ApRolePrintDb, NULL );
          }
