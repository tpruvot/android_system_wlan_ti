...
/** \file   SdioDrv.c 
 *  \brief  The OMAP3430 SDIO driver (platform and OS dependent) 
 * 
 * This program is free software; you can redistribute it and/or
 * modify it under the terms of the GNU General Public License as 
 * published by the Free Software Foundation version 2.
...
#define OMAP_MMC_REGS_BASE             IO_ADDRESS(0x480AD000)   //TIWLAN_MMC_CONTROLLER_BASE_ADDR)

//#define INT_MMC2_IRQ                   86
#define OMAP_MMC_IRQ                   94		//INT_MMC2_IRQ
/* 
...
int sdiodrv_dma_init(void)
{
	...
	rc = omap_request_dma(OMAP34XX_DMA_MMC3_TX, "SDIO WRITE", NULL /* sdiodrv_dma_write_cb */, &g_drv, &g_drv.dma_tx_channel);
	if (rc != 0) {
